...
//go:generate go run github.com/mailru/easyjson/easyjson@master -all -pkg -- ./internal/apis/formulae.brew.sh/v1  ./internal/apis/formulae.brew.sh/v2 ./internal/apis/formulae.brew.sh/v3 ./internal/apis/formulae.brew.sh/common
